...
async function test() {
  await fetchTable('attendance');
  await fetchTable('payroll');
  await fetchTable('shifts');
  await fetchTable('leaves');
  await fetchTable('employee_documents');
  await fetchTable('departments');
}
test();
